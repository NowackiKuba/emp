    ...
    return (
      <div className='flex flex-col gap-4 w-full'>
        ...
        <div className='sm:flex-row flex-col flex items-center gap-2 w-full'>
          <div className='h-80 w-96 py-2 rounded-xl bg-secondary hidden md:flex items-center justify-center flex-col gap-2 px-4'>
          ...
          <Skeleton className='h-80 w-full sm:w-96' />
          <Skeleton className='h-80 w-full sm:w-96' />
          <Skeleton className='h-80 w-full sm:w-96' />
        </div>
      </div>
